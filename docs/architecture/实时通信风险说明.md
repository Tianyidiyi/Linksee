...
> 关联文档：
> - [通信治理规范](./通信治理规范.md)
> - [docs/归档/设计草案/课程表结构设计-v1.md](../归档/设计草案/课程表结构设计-v1.md)
...
**修复动作**：
- `docs/归档/设计草案/课程表结构设计-v1.md` Phase 4 表结构：`created_by` 改为 `VARCHAR(10) NULL`
...
**修复动作**：
- `docs/归档/设计草案/课程表结构设计-v1.md` Phase 4 `chat_messages` 表：在 `created_at` 之后加 `updated_at DATETIME NOT NULL`
