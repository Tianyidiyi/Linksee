...
> 对应需求文档：[docs/product/课程场景与需求.md](../../product/课程场景与需求.md)
> Auth 组表结构见：[docs/api/auth/认证表结构设计.md](../auth/认证表结构设计.md)
...
实现状态以 [docs/status/当前交付状态.md](../../status/当前交付状态.md) 为准，若有偏差以交付状态为准。
